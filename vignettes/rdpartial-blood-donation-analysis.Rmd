...
cat(sprintf("• Dataset: %d observations (%s donors)\n", nrow(dat), 
...
For more details on the theoretical foundations, see @paper_preprint. The package documentation provides additional technical details and examples for various use cases.
