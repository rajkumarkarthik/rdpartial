...
# Run analysis across all manipulation regions sequentially
# (Parallel processing omitted in vignettes to avoid package loading issues during build)
results <- lapply(seq_along(manip_regions), function(j) {
