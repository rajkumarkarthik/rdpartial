...
if (.Platform$OS.type == "windows") {
  # Use cluster-based parallelization on Windows
  cl <- parallel::makeCluster(n_cores)
  on.exit(parallel::stopCluster(cl))
  
  # Export required objects to cluster
  parallel::clusterEvalQ(cl, library(rdpartial))
  parallel::clusterExport(cl, c("analyze_region", "manip_regions", "hist_df", 
                                "dat", "cutoff", "num_folds", "w_kernel", 
                                "outcome_col", "treatment_col", "poly_order", 
                                "treat_direction"), envir = environment())
  
  results <- parallel::parLapply(cl, seq_along(manip_regions), function(j) {
  ...
  # Use fork-based parallelization on Unix-like systems
